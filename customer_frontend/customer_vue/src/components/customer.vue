    ...
    <div>
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" >
            ...
            <div class="carousel-item active">
                <img src="../assets/image/Image.png" class="d-block w-100 h-50" alt="...">
            </div>
            <div class="carousel-item">
                <img src="../assets/image/2.png" class="d-block w-100 h-50" alt="...">
            </div>
            <div class="carousel-item">
        ...
        <div class="container-fluid">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 mt-3 mb-3">
                ...
                <img src="../assets/image/sneaker.jpg" class="card-img-top" alt="...">
